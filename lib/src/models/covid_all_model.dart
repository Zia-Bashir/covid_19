/// updated : 1670427625724
/// cases : 651187334
/// todayCases : 299781
/// deaths : 6650431
/// todayDeaths : 553
/// recovered : 627717018
/// todayRecovered : 173174
/// active : 16819885
/// critical : 37093
/// casesPerOneMillion : 83541
/// deathsPerOneMillion : 853.2
/// tests : 6849286082
/// testsPerOneMillion : 862094.8
/// population : 7944933753
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2117.06
/// recoveredPerOneMillion : 79008.46
...
class CovidAllModel {
  ...
  CovidAllModel.fromJson(dynamic json) {
...
CovidAllModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => CovidAllModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
